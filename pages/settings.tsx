        ...
        <Form>
          <Form.Group as={Row}>
            <Form.Group as={Col} controlId="first-name">
              ...
              <Form.Control type="text" placeholder="Gurdeep" required />
            </Form.Group>
            <Form.Group as={Col} controlId="last-name">
              ...
              <Form.Control type="text" placeholder="Osahan" required />
            </Form.Group>
          </Form.Group>
          ...
          <Form.Group as={Row}>
            <Form.Group as={Col} controlId="address">
              ...
              <Form.Control as="textarea" rows={3} cols={100} required />
            </Form.Group>
          </Form.Group>
          <Row>
